...
# Installation
# 1. Copy script to folder /usr/bin
# 2. Set file permissions for root user:
# sudo chmod 755 /usr/bin/cpulimit_daemon.sh
# 3. Copy script "cpulimit" to /etc/init.d/cpulimit
# 4. Change file`s owner to root
# sudo chown root:root /etc/init.d/cpulimit
# 5. Change permissions
# sudo chmod 755 /etc/init.d/cpulimit
# 6. Add script to boot-up procedure directories:
